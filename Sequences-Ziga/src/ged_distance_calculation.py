...
# =========================================================
# 4. Approx GED (Hungarian matching)
# =========================================================
def approx_ged(G1, G2):
    ...
    for i, (_, d1) in enumerate(nodes1):
        for j, (_, d2) in enumerate(nodes2):
            C[i, j] = 0 if d1["resname"] == d2["resname"] else 1
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("Usage: python ged_distance_calculation.py path1.pdb path2.pdb")
        sys.exit(1)
    ...
    print("Approx Graph Edit Distance:", ged_dist)
