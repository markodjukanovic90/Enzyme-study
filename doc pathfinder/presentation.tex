...
\begin{document}
	...
	\begin{frame}{Motivation}
		...
		\begin{itemize}
			...
			\item Most generated structures exhibit limited structural diversity (structural bias of ALphaFold noticed).
	...
	\textbf{	Different points in the workflow where to integrate Filtering \& Clustering.}
	...
	\begin{frame}{WP3 Objectives}
		...
		\begin{enumerate}
			...
			\begin{itemize}
				\item Improve candidate quality --- Remove unlikely functional structures.
			\end{itemize}
	...
	\begin{frame}{Graph-Based Structural Features}
		...
		\begin{columns}
			...
			\textbf{Advanced Features} (\textbf{some not yet explored})
	...
	\begin{frame}{Expected Impact}
		...
		\begin{itemize}
			...
			\item Increase structural diversity of EMs but also preserve catalytic functionality.
